...
public class ExcelFileUtil {
    ...
    {
    	FileInputStream fis=new FileInputStream("E:\\programs\\OrangeHRM\\TestInputs\\InputSheet.xlsx");
    ...
    FileOutputStream fos=new FileOutputStream("E:\\programs\\OrangeHRM\\TestOutput\\OutputSheet.xlsx");
    wb.write(fos);
    fos.close();
}
}
